...
if(isset($_POST['submit'])){
    ...
    //insert Product
    mysqli_query($con, "INSERT INTO `tblproduct`(`id`, `Pname`, `Pprice`,`Pquantity`, `Pimage`,`Display`, `Ram`, `Cpu`, `Storage`, `Battery`) VALUES ('$id','$product_name','$product_price','$product_quantity','$image_destination','$product_display','$product_ram','$product_cpu','$product_storage','$product_battery')");
    echo "
            <script>
